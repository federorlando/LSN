...
{       
        ...
        while(new_pop.size() < N_pop)
	{
		...
		rand = rnd.Rannyu();
		if(rand<0.05) 
			swap(new_pop[new_pop.size()-1],(int)round(rnd.Rannyu(1,N-1)),(int)round(rnd.Rannyu(1,N-1)));		//1, and not 0, to left 1st city untouched
		...
		if(rand>0.5 && rand<0.55)
			invert_order(new_pop[new_pop.size()-1],(int)round(rnd.Rannyu(1,N-1)),(int)round(rnd.Rannyu(1,N-1)));	//1, and not 0, to left 1st city untouched
		if(rand>0.75 && rand<0.8)
			part_perm(new_pop[new_pop.size()-1], (int)round(rnd.Rannyu(1,9)), (int)round(rnd.Rannyu(10,17)), (int)round(rnd.Rannyu(18,26)), (int)round(rnd.Rannyu(27,34)));													//1, and not 0, to left 1st city untouched
		...
		if(rand>0.75 && rand<0.8)
			part_perm(new_pop[new_pop.size()-2], (int)round(rnd.Rannyu(1,9)), (int)round(rnd.Rannyu(10,17)), (int)round(rnd.Rannyu(18,26)), (int)round(rnd.Rannyu(27,34)));													//1, and not 0, to left 1st city untouched
        }
...
cout << endl << "SQUARE: FINAL COST = " << final_cost << endl << endl << endl;
